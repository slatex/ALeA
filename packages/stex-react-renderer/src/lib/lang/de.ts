export const de = {
  ...
  quiz: {
    ...
    perSectionQuizButton: 'Syllabus-Probleme ($1)',
    ForMe: 'Für mich ($1)',
    adventurousproblems: 'Ich bin abenteuerlustig ($1)',
    hideProblems: 'Probleme ausblenden',
    hideForMe: 'Für mich ausblenden',
    hidepracticeProblem: 'Übungsprobleme ausblenden',
    NoPracticeProblemsForMe: 'Keine personalisierten Übungsprobleme für diesen Abschnitt verfügbar',
    NoPracticeProblemsAll: 'Keine Übungsprobleme für diesen Abschnitt verfügbar',
    answer: 'Antwort',
    point: 'Punkt',
    submit: 'Senden',
    reset: 'Zurücksetzen',
